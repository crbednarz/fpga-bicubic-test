...
object BicubicRowSim {
  class BicubicRowDut(sourceWidth: Int, sourceHeight: Int, destWidth: Int, destHeight: Int) extends Component {
    val io = new Bundle {
      val enable = in Bool()
      val busy = out Bool()
  ...
  def main(args: Array[String]) {
    ...
    SimConfig
      .withWave
      .doSim(new BicubicRowDut(sourceWidth, sourceHeight, destinationWidth, destinationHeight)) { dut =>
